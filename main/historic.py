...
def get_data_bybit_DERIVATIVES(ticker='ETHUSDT', interval='D', period=60, min=False):
    '''Period in days. Gets historical using ByBit. days https://bybit-exchange.github.io/docs/inverse/#t-orderbook. for unix time stamp https://www.unixtimestamp.com/index.php'''
